...
func Comparison() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<section id=\"comparison\" data-reveal class=\"py-20 sm:py-28 bg-surface dark:bg-next-dark relative\"><div class=\"max-w-5xl mx-auto px-4 sm:px-6 lg:px-8\"><div class=\"text-center mb-14\"><span class=\"inline-block px-3 py-1 text-xs font-mac uppercase tracking-widest text-ink-muted dark:text-next-subtle-text border border-rule dark:border-next-mid mb-6\">Cloud Infrastructure // Buying vs Renting</span><h2 class=\"text-4xl sm:text-5xl font-extrabold tracking-tighter mb-4 font-mac text-ink dark:text-next-white\">Own vs. Rent</h2><p class=\"text-lg text-ink dark:text-next-white max-w-xl mx-auto font-mac-body leading-relaxed\">Renting cloud infrastructure is like renting an apartment forever. At some point, you might want to own.</p></div><div class=\"border-2 border-ink dark:border-next-white overflow-hidden\"><table class=\"w-full text-left font-mac-body\"><thead><tr class=\"bg-ink dark:bg-next-mid uppercase tracking-wider text-xs font-mac\"><th class=\"py-3.5 px-5 sm:px-8 font-semibold text-paper dark:text-next-white\">What</th><th class=\"py-3.5 px-5 sm:px-8 font-semibold text-paper/60 dark:text-next-white/60\">Renting</th><th class=\"py-3.5 px-5 sm:px-8 font-semibold text-accent-gold-text dark:text-next-teal-text\">Owning</th></tr></thead> <tbody class=\"divide-y divide-rule dark:divide-next-mid/40\">")
		if templ_7745c5c3_Err != nil {
