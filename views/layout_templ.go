...
func Nav(activeNav string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<nav class=\"fixed top-0 w-full z-50 bg-surface-strong dark:bg-next-dark border-b border-rule dark:border-next-mid transition-colors duration-150\" x-data=\"{ mobileOpen: false }\"><div class=\"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8\"><div class=\"flex items-center justify-between h-14\"><div class=\"flex items-center gap-3\"><div class=\"w-8 h-8 bg-accent-gold dark:bg-next-teal-hi flex items-center justify-center border border-ink dark:next-raised\"><svg class=\"w-5 h-5 text-ink dark:text-next-white\" viewBox=\"0 0 32 32\" fill=\"currentColor\" aria-hidden=\"true\"><rect x=\"4\" y=\"6\" width=\"24\" height=\"14\" rx=\"1\"></rect> <rect x=\"12\" y=\"20\" width=\"8\" height=\"2\"></rect> <rect x=\"8\" y=\"22\" width=\"16\" height=\"2\" rx=\"0.5\"></rect></svg></div><span class=\"text-lg font-bold font-mac text-ink dark:text-next-white tracking-wide\">Rezus<span class=\"text-accent-gold dark:text-next-teal\">Cloud</span></span></div><div class=\"hidden md:flex items-center gap-1 text-sm font-mac\"><a href=\"/#hero\" x-bind:class=\"activeNav === '' && $store.scroll.active === 'hero' ? 'px-3 py-2 text-ink dark:text-next-black bg-paper dark:bg-next-light' : 'px-3 py-2 text-ink-muted dark:text-next-subtle hover:bg-paper dark:hover:bg-next-mid transition-colors duration-120'\">Home</a> <a href=\"/#architecture\" x-bind:class=\"activeNav === '' && $store.scroll.active === 'architecture' ? 'px-3 py-2 text-ink dark:text-next-black bg-paper dark:bg-next-light' : 'px-3 py-2 text-ink-muted dark:text-next-subtle hover:bg-paper dark:hover:bg-next-mid transition-colors duration-120'\">Architecture</a> <a href=\"/#features\" x-bind:class=\"activeNav === '' && $store.scroll.active === 'features' ? 'px-3 py-2 text-ink dark:text-next-black bg-paper dark:bg-next-light' : 'px-3 py-2 text-ink-muted dark:text-next-subtle hover:bg-paper dark:hover:bg-next-mid transition-colors duration-120'\">Features</a> <a href=\"/#getstarted\" x-bind:class=\"activeNav === '' && $store.scroll.active === 'getstarted' ? 'px-3 py-2 text-ink dark:text-next-black bg-paper dark:bg-next-light' : 'px-3 py-2 text-ink-muted dark:text-next-subtle hover:bg-paper dark:hover:bg-next-mid transition-colors duration-120'\">Get Started</a> <span class=\"mx-1 text-rule dark:text-next-mid\">|</span> <a href=\"/docs\" x-bind:class=\"activeNav === 'docs' ? 'px-3 py-2 text-ink dark:text-next-black bg-paper dark:bg-next-light' : 'px-3 py-2 text-ink-muted dark:text-next-subtle hover:bg-paper dark:hover:bg-next-mid hover:text-accent-gold dark:hover:text-next-teal transition-colors duration-120'\">Docs</a></div><div class=\"flex items-center gap-3\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
